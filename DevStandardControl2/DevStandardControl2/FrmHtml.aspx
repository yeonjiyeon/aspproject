<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmHtml.aspx.cs" Inherits="DevStandardControl2.FrmHtml" %>
        ...
        <div>
            ...
            <asp:ImageMap ID="mapHome" runat="server" ImageUrl="./images/btn_home.gif">
                ...
                <asp:CircleHotSpot AlternateText="닷넷코리아" HotSpotMode="Navigate" 
                    NavigateUrl="http://www.dotnetkorea.com/" Radius="5" Target="_blank" X="16" Y="16" />
            </asp:ImageMap><br />
            <br />
            ...
            <asp:Table ID="tbTable" runat="server" GridLines="Both">
