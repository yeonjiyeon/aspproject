<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmCheckBoxList.aspx.cs" Inherits="DevStandardControl2.FrmCheckBoxList" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:CheckBoxList ID="lstHobby" runat="server" RepeatDirection="Horizontal"
