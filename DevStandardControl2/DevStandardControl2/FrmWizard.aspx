<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmWizard.aspx.cs" Inherits="DevStandardControl2.FrmWizard" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Wizard ID="Wizard1" runat="server" Width="600px" Height="200px"
                BorderWidth="1px" OnFinishButtonClick="Wizard1_FinishButtonClick">
                <WizardSteps>
