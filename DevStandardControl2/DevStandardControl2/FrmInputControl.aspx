<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmInputControl.aspx.cs" Inherits="DevStandardControl2.FrmInputControl" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table style="width: 500px">
                <tr>
                    <td style="width: 500px">체크박스(이용약관):</td>
                ...
                <tr>
                    ...
                    <td style="width:100px">
                        <asp:CheckBoxList ID="lstHobby" runat="server" RepeatColumns="2"
                            RepeatDirection="Horizontal" RepeatLayout="Flow" Width="202px">
                ...
                <tr>
                    ...
                    <td style="width: 100px">
                        <asp:RadioButtonList ID="lstWedding" runat="server" 
                            RepeatDirection="Horizontal" RepeatLayout="Flow" Width="110px">
