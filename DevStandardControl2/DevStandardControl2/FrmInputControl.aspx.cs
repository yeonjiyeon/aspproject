...
namespace DevStandardControl2
{
    public partial class FrmInputControl : System.Web.UI.Page
    {
        ...
        protected void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                sb.AppendFormat("[2]" + this.lstHobby.Items[0].Value + "<br/>");
            }
            ...
            sb.AppendFormat("[4] {0} 선택<br />", lstWedding.SelectedItem.Text);

            // [5] 드롭다운리스트 값 받아 오기 : 단일값
            sb.AppendFormat("[5] {0} 선택<br />", lstJob.Items[lstJob.SelectedIndex].Value);
            ...
            for (int i = 0; i < lstFavorite.Items.Count; i++)
            {
                ...
                {
                    sb.AppendFormat("[6] {0} 선택<br />", lstFavorite.Items[i].Value);
                }
            }
            // –OR–
